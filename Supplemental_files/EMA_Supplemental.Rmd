...
g1 <- ggplot(data = supp_descrip_study1, 
           aes(x = DN, 
               y = NegEvnt_mean))+
  geom_point(alpha = .75, color = "#ffd520")+
  stat_smooth(method = "lm", se = FALSE, color = "#E03a3e")+
...
plot_samp1 %>% 
  ...
  geom_point(size = 1.5) +
  geom_line() + 
  scale_color_manual(values = c("Horn's Parallel Analysis" = "#ffd520", 
                                "Obtained Eigenvalues" = "#E03a3e"), name = "") +
