...
data_loader(POSTERIOR_PATH, "S2_POS_PosEvnt_DN_prop.PosEvnt")
...
#----------------------------------------------------------------------------------------------------------------------
# Next Set of inputs - lv2 no interaction
data_loader(POSTERIOR_PATH, "S2_POS_PosEvnt_DN")
within_vars <- c("c.PosEvnt")
between_vars <- c("c.DN")
random_vars <- c("c.PosEvnt")
...
#----------------------------------------------------------------------------------------------------------------------
# Next Set of inputs - lv2 no interaction
data_loader(POSTERIOR_PATH, "S2_POS_PosEvnt_prop.PosEvnt")
within_vars <- c("c.PosEvnt")
...
#----------------------------------------------------------------------------------------------------------------------
# Next Set of inputs - lv2 no interaction
data_loader(POSTERIOR_PATH, "S2_POS_PosEvnt")
within_vars <- c("c.PosEvnt")
between_vars <- NULL
random_vars <- c("c.PosEvnt")
