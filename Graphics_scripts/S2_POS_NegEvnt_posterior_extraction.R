...
data_loader(POSTERIOR_PATH, "S2_POS_NegEvnt_DN_prop.NegEvnt")
...
#----------------------------------------------------------------------------------------------------------------------
# Next Set of inputs - lv2 no interaction
data_loader(POSTERIOR_PATH, "S2_POS_NegEvnt_DN")
within_vars <- c("c.NegEvnt")
between_vars <- c("c.DN")
random_vars <- c("c.NegEvnt")
...
#----------------------------------------------------------------------------------------------------------------------
# Next Set of inputs - lv2 no interaction
data_loader(POSTERIOR_PATH, "S2_POS_NegEvnt_prop.NegEvnt")
within_vars <- c("c.NegEvnt")
...
#----------------------------------------------------------------------------------------------------------------------
# Next Set of inputs - lv2 no interaction
data_loader(POSTERIOR_PATH, "S2_POS_NegEvnt")
within_vars <- c("c.NegEvnt")
between_vars <- NULL
random_vars <- c("c.NegEvnt")
