...
ppc_density <- 
  pp_check(S2_NEG_ucm, 
           ...
           nsamples = 100)+
  ggtitle("S2_NEG_ucm Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_DN, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_DN Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_prop.NegEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_prop.NegEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_prop.PosEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_prop.PosEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_DN_prop.NegEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_DN_prop.NegEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_DN_prop.PosEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_DN_prop.PosEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_NegEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_NegEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_PosEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_PosEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_NegEvnt_DN, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_NegEvnt_DN Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_PosEvnt_DN, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_PosEvnt_DN Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_NegEvnt_prop.NegEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_NegEvnt_prop.NegEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_PosEvnt_prop.PosEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_PosEvnt_prop.PosEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_NegEvnt_DN_prop.NegEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_NegEvnt_DN_prop.NegEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_PosEvnt_DN_prop.PosEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_PosEvnt_DN_prop.PosEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_NegEvnt_x_DN_prop.NegEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_NegEvnt_x_DN_prop.NegEvnt Posterior Predictive Distribution")
...
ppc_density <- 
  pp_check(S2_NEG_PosEvnt_x_DN_prop.PosEvnt, 
           newdata = dat.study2_list_stacked,
           nsamples = 100)+
  ggtitle("S2_NEG_PosEvnt_x_DN_prop.PosEvnt Posterior Predictive Distribution")
